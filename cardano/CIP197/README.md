...
The Aiken verifier lives in `../../bls/aiken/nova-slim/`.

```bash
cd ../../bls/aiken/nova-slim
...
aiken apply plutus.json \
  --parameter-bytes $(cat ../../../nova-slim/cardano/CIP197/account_key.hex) \
  > validator.uplc
...
- [Aiken Verifier](https://github.com/cardano-foundation/bls/tree/main/aiken/nova-slim)
